...
class CollectTrainingData(object):
    ...
    def __init__(self, host, port, input_size, factory):
        ...
        right = LED(27, pin_factory=factory)
        left = LED(17, pin_factory=factory)
        forward = LED(10, pin_factory=factory)
        backward = LED(9, pin_factory=factory)
...
if __name__ == '__main__':
    ...
    ctd = CollectTrainingData(h, p, s, factory)
    ctd.collect()
